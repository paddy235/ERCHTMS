...
namespace BSFramework.CodeGenerator.Template
{
    ...
    {
        private string AssTag = Assembly.GetExecutingAssembly().ManifestModule.Name.Substring(0, Assembly.GetExecutingAssembly().ManifestModule.Name.LastIndexOf("."));
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.AppendFormat("namespace {0}.Entity." + multiTableConfigModel.OutputAreas + "\r\n",AssTag);
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("using {0}.Entity." + multiTableConfigModel.OutputAreas + ";\r\n",AssTag);
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.AppendFormat("namespace {0}.Mapping." + multiTableConfigModel.OutputAreas + "\r\n",AssTag);
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
                sb.Append("    /// </summary>\r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("using {0}.Entity." + multiTableConfigModel.OutputAreas + ";\r\n", AssTag);
            sb.AppendFormat("using {0}.IService." + multiTableConfigModel.OutputAreas + ";\r\n",AssTag);
            ...
            sb.AppendFormat("namespace {0}.Service." + multiTableConfigModel.OutputAreas + "\r\n",AssTag);
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.AppendFormat("namespace {0}.IService." + multiTableConfigModel.OutputAreas + "\r\n",AssTag);
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.AppendFormat("using {0}.Entity." + multiTableConfigModel.OutputAreas + ";\r\n",AssTag);
            sb.AppendFormat("using {0}.IService." + multiTableConfigModel.OutputAreas + ";\r\n",AssTag);
            sb.AppendFormat("using {0}.Service." + multiTableConfigModel.OutputAreas + ";\r\n",AssTag);
            sb.Append("using BSFramework.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.AppendFormat("namespace {0}.Busines." + multiTableConfigModel.OutputAreas + "\r\n",AssTag);
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("using {0}.Entity." + multiTableConfigModel.OutputAreas + ";\r\n",AssTag);
            sb.AppendFormat("using {0}.Busines." + multiTableConfigModel.OutputAreas + ";\r\n",AssTag);
            sb.Append("using BSFramework.Util;\r\n");
            sb.Append("using BSFramework.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.AppendFormat("namespace {0}.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n",AssTag);
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
        ...
        public string IndexBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, List<GridColumnModel> gridChildColumnModel)
        {
            ...
            sb.Append("            <a id=\"details\" class=\"btn btn-default\" onclick=\"btn_details()\"><i class=\"fa fa-list-alt\"></i>详细</a>\r\n");
            sb.Append("        </div>\r\n");
            sb.Append("    </div>\r\n");
            sb.Append("</div>\r\n");
