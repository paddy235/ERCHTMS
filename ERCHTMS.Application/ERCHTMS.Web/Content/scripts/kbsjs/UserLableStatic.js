...
//首页人员类别
function IndexLable() {
    $.get(top.contentPath + "/KbsDeviceManage/SafeUserControl/GetLableChart", {}, function (data) {
        var count = 0;
        var list = eval(data);
        ...
        //人员类别列表
        $.ajax({
            url: top.contentPath + "/KbsDeviceManage/SafeUserControl/GetUserOnlineGroupJson",
            type: "post",
            dataType: "json",
            async: false,
