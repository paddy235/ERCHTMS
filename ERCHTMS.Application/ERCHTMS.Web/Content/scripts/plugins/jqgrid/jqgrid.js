                ...
                if ("TABLE" !== this.tagName.toUpperCase()) alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        for (g = 0; g < this.p.colNames.length; g++) {
                            ...
                            var al = a.p.colModel[g].headerAlign == undefined ? a.p.colModel[g].align : a.p.colModel[g].headerAlign;
                            if (bb != undefined) {
                                bc = 0
                            } else {
                                j += bc
                            ...
                            D += "<th id='" + a.p.id + "_" + a.p.colModel[g].name + "' style='text-align:" + al + ";' role='columnheader' class='ui-state-default ui-th-column ui-th-" + f + "'" + F + ">",
