...
fileUrl = fileUrl.split("?fileUrl=");
var DEFAULT_URL = fileUrl[1];
            ...
            onActiveChanged: function (isActive) {
                ...
                if (isActive) {
                    toggleHandTool.title =
                      mozL10n.get('hand_tool_disable.title', null, '禁用手形工具');
                    toggleHandTool.firstElementChild.textContent =
                      mozL10n.get('hand_tool_disable_label', null, '禁用手形工具');
                } else {
                    toggleHandTool.title =
                      mozL10n.get('hand_tool_enable.title', null, '启用手形工具');
                    toggleHandTool.firstElementChild.textContent =
                      mozL10n.get('hand_tool_enable_label', null, '启用手形工具');
                }
            }
        });
        if (toggleHandTool) {
