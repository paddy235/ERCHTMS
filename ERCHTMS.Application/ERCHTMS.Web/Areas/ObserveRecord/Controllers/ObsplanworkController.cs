...
namespace ERCHTMS.Web.Areas.ObserveRecord.Controllers
{
    ...
    /// 描 述：观察计划任务分解
    /// </summary>
    public class ObsplanworkController : MvcControllerBase
    {
        ...
        public ActionResult GetPlanWorkList(Pagination pagination, string queryJson)
        {
            ...
            pagination.p_tablename = @"bis_obsplanwork t";
        ...
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, ObsplanworkEntity entity)
        {
        ...
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult TbSaveForm(string keyValue, ObsplanworkEntity entity)
        {
            obsplanworkbll.SaveForm(keyValue, entity);
