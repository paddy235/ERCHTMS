...
left join base_department d on d.departmentid=u.departmentid
                ...
                excelconfig.Title = "观察记录列表";
                excelconfig.FileName = "观察记录列表导出.xls";
                ...
                //需跟数据源列顺序保持一致
                excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "workname", ExcelColumn = "作业名称", Width = 300 });
                excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "createuserdept", ExcelColumn = "登记部门", Width = 300 });
                excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "workunit", ExcelColumn = "作业部门", Width = 300 });
                excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "workpeople", ExcelColumn = "作业人员", Width = 300 });
                excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "workarea", ExcelColumn = "作业区域", Width = 300 });
                excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "obsstarttime", ExcelColumn = "观察起始时间", Width = 300 });
                excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "obsendtime", ExcelColumn = "观察结束时间", Width = 300 });
                excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "obsperson", ExcelColumn = "观察人员", Width = 300 });
                excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "deptname", ExcelColumn = "观察人员部门", Width = 300 });
        ...
        public ActionResult ExportData(string keyValue)
        {
            ...
            #endregion
            ObserverecordEntity obsRecord = observerecordbll.GetEntity(keyValue);//观察记录实体
            #region 表头样式
            builder.InsertCell();
