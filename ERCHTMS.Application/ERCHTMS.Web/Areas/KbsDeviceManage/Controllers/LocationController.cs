...
namespace ERCHTMS.Web.Areas.KbsDeviceManage.Controllers
{
    ...
    /// 描 述：定位点记录表
    /// </summary>
    public class LocationController : MvcControllerBase
    {
        ...
        {
            var data = locationbll.GetEntity(keyValue);
            return ToJsonResult(data);
        }
        #endregion
        ...
        {
            locationbll.RemoveForm(keyValue);
            return Success("删除成功。");
        }
        /// <summary>
        /// 保存表单（新增、修改）
        ...
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, LocationEntity entity)
        {
