...
namespace ERCHTMS.Web.Areas.SafetyWorkSupervise.Controllers
{
    ...
    /// 描 述：安全重点工作督办反馈信息
    /// </summary>
    public class SuperviseconfirmationController : MvcControllerBase
    {
        ...
        {
            var data = superviseconfirmationbll.GetList(queryJson);
        ...
        {
            var data = superviseconfirmationbll.GetEntity(keyValue);
            return ToJsonResult(data);
        }
        #endregion
        ...
        {
            superviseconfirmationbll.RemoveForm(keyValue);
            return Success("删除成功。");
        }
        /// <summary>
        /// 保存表单（新增、修改）
