...
namespace ERCHTMS.Web.Areas.AuthorizeManage.Controllers
{
    ...
    public class PermissionRoleController : MvcControllerBase
    {
        ...
        public ActionResult GetDepartmentTreeJson(string roleId)
        {
            ...
            string orgId= string.IsNullOrEmpty(roleEntity.OrganizeId) ? OperatorProvider.Provider.Current().OrganizeId: roleEntity.OrganizeId;
            var organizeEntity = organizeBLL.GetEntity(orgId);
            var data = departmentCache.GetList(orgId);
        ...
        /// </summary>
        /// <param name="roleId">角色Id</param>
        /// <param name="deptId">机构或部门Id</param>
        /// <returns></returns>
        [HttpGet]
