...
namespace ERCHTMS.Web.Areas.SafePunish.Controllers
{
    ...
    /// 描 述：安全惩罚
    /// </summary>
    public class SafekpidataController : MvcControllerBase
    {
        ...
        {
            var data = safekpidatabll.GetList(queryJson);
        ...
        {
            var data = safekpidatabll.GetEntity(keyValue);
            return ToJsonResult(data);
        }
        #endregion
        ...
        {
            safekpidatabll.RemoveForm(keyValue);
            return Success("删除成功。");
        }
        /// <summary>
        /// 保存表单（新增、修改）
