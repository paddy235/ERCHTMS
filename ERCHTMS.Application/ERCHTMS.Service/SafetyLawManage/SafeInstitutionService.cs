...
namespace ERCHTMS.Service.SafetyLawManage
{
    ...
    /// 描 述：安全管理制度
    /// </summary>
    public class SafeInstitutionService : RepositoryFactory<SafeInstitutionEntity>, SafeInstitutionIService
    {
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回分页列表</returns>
        public IEnumerable<SafeInstitutionEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<SafeInstitutionEntity> GetList(string queryJson)
        {
            if (!string.IsNullOrWhiteSpace(queryJson))
            {
                string sql = "select * from BIS_SAFEINSTITUTION";
        ...
        /// <returns></returns>
        public SafeInstitutionEntity GetEntity(string keyValue)
        {
        ...
        public void RemoveForm(string keyValue)
        {
            ...
            try
            {
                db.Delete<SafeInstitutionEntity>(keyValue);
