...
namespace ERCHTMS.Service.StandardSystem
{
    ...
    /// 描 述：标准化新闻
    /// </summary>
    public class StandardNewsService : RepositoryFactory<StandardNewsEntity>, StandardNewsIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public void SaveForm(string keyValue, StandardNewsEntity entity)
        {
            ...
            {
                StandardNewsEntity se = this.BaseRepository().FindEntity(keyValue);
                if (se == null)
                {
                    entity.Create();
