...
{
  public  class ObsTaskAnalysisReportService : RepositoryFactory<ObsTaskAnalysisReportEntity>, ObsTaskAnalysisReportIService
    {
        /// <summary>
        /// 获取分页数据
        /// </summary>
        ...
        /// <returns></returns>
        public ObsTaskAnalysisReportEntity GetEntity(string keyValue)
        {
        ...
        public void SaveForm(string keyValue, ObsTaskAnalysisReportEntity entity)
        {
