...
namespace ERCHTMS.Service.LaborProtectionManage
{
    ...
    /// 描 述：劳动防护信息关联表
    /// </summary>
    public class LaborequipmentinfoService : RepositoryFactory<LaborequipmentinfoEntity>, LaborequipmentinfoIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        {
            return this.BaseRepository().IQueryable(it => it.AssId == queryJson).ToList();
        }
