...
namespace ERCHTMS.Entity.RiskDatabase
{
    ...
    /// 描 述：企业风险辨识评估记录
    /// </summary>
    public class RiskAssessEntity : BaseEntity
    {
        #region 实体成员
        /// <summary>
        /// 内置区域名称
        ...
        /// <summary>
        /// 记录状态,0:初始默认值，已关联部门和岗位,1:已关联标准区域，2:辨识评估计划中新增的
        /// </summary>
        /// <returns></returns>
        [Column("STATUS")]
        ...
        public override void Create()
        {
            ...
            this.State = 0;
            this.Grade = string.IsNullOrWhiteSpace(this.Grade) ? "" : this.Grade.Replace("一级风险", "重大风险").Replace("二级风险", "较大风险").Replace("三级风险", "一般风险").Replace("四级风险", "低风险");
