...
namespace ERCHTMS.Entity.OutsourcingProject
{
    ...
    /// 描 述：dddd
    /// </summary>
    [Table("EPG_PROJECTTOOLS")]
    public class ProjecttoolsEntity : BaseEntity
    {
        #region 实体成员
        /// <summary>
        /// 
        ...
        /// </summary>
        /// <returns></returns>
        [Column("PROJECTTOOLSID")]
        public string PROJECTTOOLSID { get; set; }
        /// <summary>
        /// 设备名称
        /// </summary>
        /// <returns></returns>
        ...
        {
            this.PROJECTTOOLSID = string.IsNullOrEmpty(PROJECTTOOLSID) ? Guid.NewGuid().ToString() : PROJECTTOOLSID;
