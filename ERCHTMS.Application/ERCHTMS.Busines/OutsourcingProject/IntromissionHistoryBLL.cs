...
namespace ERCHTMS.Busines.OutsourcingProject
{
    ...
    /// 描 述：入厂许可申请
    /// </summary>
    public class IntromissionHistoryBLL
    {
        private IntromissionHistoryIService service = new IntromissionHistoryService();
        ...
        {
            return service.GetEntityByIntromId(keyValue);
        }
        #endregion
