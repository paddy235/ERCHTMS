...
{
   public  class ObserveTaskrecordBLL
    {
        private ObserveTaskrecordIService service = new ObserveTaskrecordService();
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, ObserveTaskrecordEntity entity, List<ObserveTaskcategoryEntity> listCategory, List<ObserveTasksafetyEntity> safetyList)
        {
            try
            {
