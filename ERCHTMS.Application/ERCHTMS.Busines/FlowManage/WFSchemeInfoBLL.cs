...
using ERCHTMS.Service.FlowManage;
...
namespace ERCHTMS.Busines.FlowManage
{
    /// <summary>
    /// 描 述：工作流流程模板操作
    /// </summary>
    public class WFSchemeInfoBLL
    {
        ...
        public WFSchemeContentEntity GetContentEntity(string keyValue)
        {
            try
            {
                return schemeserver.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int RemoveContentEntity(string keyValue)
        {
            return schemeserver.RemoveEntity(keyValue);
        }
        #endregion
    }
}
