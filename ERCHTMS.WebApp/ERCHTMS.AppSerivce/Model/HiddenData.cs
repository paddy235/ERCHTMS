...
namespace ERCHTMS.AppSerivce.Model
{
    public class HiddenData
    {
        ...
        public string hidbmid { get; set; } // 所属部门id
        public string hidbmname { get; set; } // 所属部门名称
        ...
        public string safetycheckname { get; set; } //安全检查名称
        public string chargeperson { get; set; } //整改责任负责人
        public string chargepersonname { get; set; } //整改责任负责人姓名
        public string chargedeptid { get; set; } //整改责任单位
        public string chargedeptname { get; set; } //整改责任单位名称
        public string isappoint { get; set; } //是否指定整改责任人
        public bool isshowappoint { get; set; } //是否具有指定整改责任人的权限

        public bool isdeliver { get; set; } //是否可以转交

        public bool isacceptdeliver { get; set; } //是否可以验收转交
        //-------------------------------
        ...
        public string changeplanid { get; set; } //整改计划id

        public string changeplaninfo { get; set; } //整改计划信息

        public IList<Photo> changeplanfiles { get; set; } // 整改计划   

        public bool isenableaccept { get; set; } //是否控制验收人设置

        public bool isenablemajorclassify { get; set; } //是否启用专业分类
        public bool yhpicmustupload { get; set; } //隐患图片是否必传
        public bool zgpicmustupload { get; set; }//隐患整改图片是否必传
        public bool yspicmustupload { get; set; }//隐患验收图片是否必传
