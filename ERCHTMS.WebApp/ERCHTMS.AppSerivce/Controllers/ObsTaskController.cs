...
{
    public class ObsTaskController : BaseApiController
    {
        ...
        public object GetObsInfo([FromBody]JObject json)
        {
            try
            {
                ...
                ObserveTaskrecordEntity obsRecord = observerecordbll.GetEntity(obsid);
                //观察类别
        ...
        public object GetObsAddByUser([FromBody]JObject json)
        {
            try
            {
                ...
                dynamic dy = JsonConvert.DeserializeObject<ExpandoObject>(res);
                string userid = dy.userid;
                string moduleid = "93f8dfdb-7d0d-4e16-913c-a841e9b9bd5c";          //观察记录的菜单ID
                string encode = "add";
        ...
        public object SaveOrCommitData()
        {
            try
            {
                ...
                var recordEntity = JsonConvert.DeserializeObject<ObserveTaskrecordEntity>(obsRecordEntity);
                //观察类别
        ...
        public object CommitSafetyData()
        {
            try
            {
                ...
                var safetyEntity = JsonConvert.DeserializeObject<ObserveTasksafetyEntity>(safetyData);
